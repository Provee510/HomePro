...
const VerticalDivider = ({ height = '100px', width = '1px', color = 'white' }) => {
  ...
  return (
    <>
      <div className="bg-black text-white flex flex-wrap items-center justify-between p-3 lg:rounded-full  rounded-lg  mt-16  ml-8 mr-8  mb-5    flex-col lg:flex-row ">
        {/* Location */}
        ...
        <div className="flex-1 mx-2 relative">
          <h1 className="text-xl font-semibold mb-1">PROPERTY TYPE</h1>
          <div className="flex items-center">
          ...
          {isPropertyTypeOpen && (
            <div className="absolute top-full left-0 bg-white text-black rounded-md p-2 z-10">
              <p
                onClick={() =>
                  handleSelect(setSelectedPropertyType, "Bungalow")
                }
                className="cursor-pointer hover:bg-gray-200 p-2"
              >
                Bungalow
              ...
              <p
                onClick={() =>
                  handleSelect(setSelectedPropertyType, "Penthouse")
                }
                className="cursor-pointer hover:bg-gray-200 p-2"
              >
                Penthouse
        ...
        <div className="flex-1 mx-2 relative">
          ...
          {isPriceRangeOpen && (
            <div className="absolute top-full left-0 bg-white text-black rounded-md p-2 z-10">
              ...
              <p
                onClick={() =>
                  handleSelect(setSelectedPriceRange, "1B and above")
                }
                className="cursor-pointer hover:bg-gray-200 p-2"
              >
                1B and above
